 ...
 */
final class Version20190730062734 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_pkg_uvdesk_ecommerce_ticket_order_details (id INT AUTO_INCREMENT NOT NULL, ticket_id INT NOT NULL, order_id VARCHAR(255) NOT NULL, order_details JSON NOT NULL COMMENT \'(DC2Type:json_array)\', INDEX IDX_2BF206E6700047D2 (ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE uv_pkg_uvdesk_ecommerce_ticket_order_details ADD CONSTRAINT FK_2BF206E6700047D2 FOREIGN KEY (ticket_id) REFERENCES uv_ticket (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uv_pkg_uvdesk_ecommerce_ticket_order_details DROP FOREIGN KEY FK_2BF206E6700047D2');
        ...
        $this->addSql('DROP TABLE uv_pkg_uvdesk_ecommerce_ticket_order_details');
